...
if (!is_user_logged_in()) {
    // Display a message indicating the page is private and requires login
?>
    <div class="container">
    ...
    <main class="page-body">
        <div class="blog-page">
            ...
            <section id="recent-order-wrap">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 col-lg-12 col-xl-9 latest-news">
                            <?php
                            while (have_posts()) {
                                the_post();
                                $categories = get_the_category();
                        ...
                        <div class="col-md-12 col-lg-12 col-xl-3 blog-categories">
