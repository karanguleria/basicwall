<?php
/**
 * Template Name: Request For Literature 
 */
?>
<?php get_header(); ?>
...
<div class="container">
    <div class="row">
	    <?php
// Check rows exists.
            if (have_rows('request_button_repeater')):

                // Loop through rows.
                while (have_rows('request_button_repeater')) : the_row();

                    // Load sub field value.
                    $title = get_sub_field('request_button_title');
                    $link = get_sub_field('request_button_link');
                    $icon = get_sub_field('request_button_icon');
                    ?>
