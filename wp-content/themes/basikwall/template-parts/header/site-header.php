	...
	<div class="top_bar">
    	<div class="container">
			<div class="row align-items-center">
				...
				<!-- <div class="left_box col-sm-8">                 	
				   	<ul class='d-flex align-items-center'>
                        <li>
				    	<a href="<?php //echo $acf_address_link?>"><i class="fa fa-home" aria-hidden="true"></i></i><?php //echo $acf_address_text?></a>
				   		</li>					
					<li>
				    	<a href="mailto:<?php //echo $acf_email?>"><i class="fa fa-envelope-o" aria-hidden="true"></i><?php //echo $acf_email?></a>
				   		</li>
					   	<li>
					   		<a href="tel:+1<?php //echo $acf_phone_number?>"><i class="fa fa-phone" aria-hidden="true"></i><?php// echo $acf_phone_number?></a>
					   	</li>
				   	</ul>
			   	</div> -->
